...
export default function OrgSignUp(props) {
  ...
  return (
    <div class="create-org-div">
      <h2>Tell us more about your team!</h2>
      <p>
        Fill out the below form. An admin account associated to your email will
        be automatically created for the organization.
      </p>
      <form class="org-form">
        <input
          type="text"
        ...
        <button class="buttons" type="reset" onClick={e => handleCancel(e)}>
          Cancel
        </button>
      </form>
    </div>
